<form action="{{ url('/biodata/tendik/import_ajax') }}" method="POST" id="form-import-tendik" enctype="multipart/form-data">
    @csrf
    <div id="modal-import-tendik" class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Import Data Tendik</h5>
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <a href="{{ asset('template_tendik.xlsx') }}" class="btn btn-info btn-sm" download>
        ...
        submitHandler: function(form) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    if(response.status) {
                        $('#modal-import-tendik').modal('hide');
                        Swal.fire({
                            icon: 'success',
                            title: 'Berhasil',
